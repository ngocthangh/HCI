...
$(document).ready(function() {
	...
	$('#newsletter input[type="submit"]').click(function(){
		...
		if(val.toUpperCase().match(regEmail)){
			$.ajax({
				type: 'POST',
				url: '-'/*tpa=http://www.umitkaraosmanoglu.com/works/travel_bookingg/assets/scripts/sendmail.php*/,
	...
	$('.customCheck').screwDefaultButtons({
        image: 'url("-"/*tpa=http://www.umitkaraosmanoglu.com/works/travel_bookingg/assets/scripts/assets/images/checkbox.png*/)',
        width: 15,
        height: 13
    });
